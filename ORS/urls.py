...
from .views import Signup_SendOTPView , Signup_VerifyOTP,LoginView , PreferenceSaveView , GeminiSuggestOutfit , EssentialItemsListView, AddEssentialToWardrobeView
...
urlpatterns = [
    ...
    path('add-essential-to-wardrobe/', AddEssentialToWardrobeView.as_view(), name='adding from essential to wardrobe')
]